...
namespace Spryker\Client\PaymentExternal\Dependency\Client;

use Spryker\Shared\Kernel\Transfer\TransferInterface;

class PaymentExternalToZedRequestClientBridge implements PaymentExternalToZedRequestClientInterface
{
    /**
