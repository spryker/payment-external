...
class PaymentExternalToSalesFacadeBridge implements PaymentExternalToSalesFacadeInterface
{
    /**
    ...
    {
        return $this->salesFacade->cancelOrder($orderCancelRequestTransfer);
    }
